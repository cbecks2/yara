...
def get_rules_from_git():
	shutil.rmtree("./rules")
	os.system("git clone https://github.com/malpedia/signator-rules") #replace with git repo!

def list_yara_files():
	all_yara_files = []
	for root, directories, filenames in os.walk("./signator-rules/rules"): ##replace with repo name!
